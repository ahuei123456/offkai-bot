...
class EventsCog(commands.Cog):
    ...
    @app_commands.describe(
        ...
        date_time="The event date and time. Examples: '2024-08-15 19:30' or 'tomorrow 7pm'. Assumed JST.",
        deadline="The signup deadline. Examples: '2024-08-15 18:00' or 'friday 6pm'. Assumed JST.",
    ...
    @app_commands.describe(
        ...
        date_time="Optional: The new date and time, for example '2024-08-15 19:30' or 'tomorrow 7pm'.",
        deadline="Optional: The new registration deadline, for example '2024-08-15 18:00' or 'friday 6pm'.",
